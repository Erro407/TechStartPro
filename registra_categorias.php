...
//verifica se o aruqivo realmente foi enviado
if($nameFile == ''){

}else {

  //metodos de leitura do csv
	$file = fopen($nameFile, 'r');

		while (($dados = fgetcsv($file, 250,";")) !== FALSE)
	 		{
				$nome = utf8_encode($dados[0]);
				//Query para executar na Mysql
  ...
  <section class="menu cid-s48OLK6784" once="menu" id="menu1-h">
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            ...
            <!-- Menu de navegação dentro do site-->
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                  ...
                  <li class="nav-item"><a class="nav-link link text-black display-4" href="excluir">Excluir Produto</a></li>
                </ul>               
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1">
                  ...
                  //verificacao se o dado foi iomportado
                 	if($result){
                 		           echo 'Os dados de cadastro foram inseridos no banco de dados com sucesso!';
 					        }else{ 	
 						                   echo 'Não foi possivel inserir os dados no banco de dados!';
 					               }
	                ?>  
            		</strong></h1>
                
                <p class="mbr-text mbr-fonts-style display-7">Para acessar as funcionalidades do sistema favor utilizar a barra de navegação acima.</p>
