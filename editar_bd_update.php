                        ...
                        <?php
                          ...
                          //teste se as variaveis estão null
                            ...
                            while($registrocategoria = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                      ...
                                      //busca variaveis dentro do banco de dados.
...
<?php  
  ...
  //Recebe as variaveis para alteração no banco de dados a partir do codProduto
  $codProduto =     $_GET['codProduto'];
  $nome =       $_GET['nome'];
  $descricao =    $_GET['descricao'];
  $valor =        $_GET['valor'];
  echo $codcategoria =   $_GET['catproduct'];
  
  if($codcategoria == 'Selecione uma categoria..'){
       $sql = "select * from tb_produtos
       where id = $codProduto
      ";


      $resultado = mysqli_query($linkConect , $sql );



      while($registrocategoria = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
            $valorcategoria = $registrocategoria['fk_categoria'];
  ...
  $sql = "UPDATE tb_produtos
      SET nome = '$nome' ,
       descricao = '$descricao',
       valor = $valor,
       fk_categoria = $valorcategoria
      WHERE id = $codProduto;
      ";

 echo $sql;

  mysqli_query($linkConect , $sql );
