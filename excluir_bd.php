<?php 
    ...
    $sql = "delete from tb_produtos where id = $idDelete";

    if(mysqli_query($linkConect , $sql )){
    	$resultado = "Produto excluido com sucesso!";
    }else{
    	$resultado = "Não foi possível excluir o produto solicitado, por favor verifique o cod_produto e tente novamente.";
    };
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-12">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-4"><strong>
                    ...
                    <form action="excluir_bd.php"  method="GET">
                            <div class="form-group">
                              <label><?php  echo $resultado ?></label>
                              <input name="delete" type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Digite aqui">
